...
df = pd.DataFrame(columns=['filename', 'timestamp','ppn', 'page_number', 'arabic_numeral_present', 'arabic_numeral_int', 'illustration_present', 'illustration_position', 'illustration_with_text_below', 'tibetian_page_number', 'chinese_char_present', 'chinese_page_number', 'box_present'])

# configure logging
l.basicConfig(level=l.INFO)

# traverse all files in the assets directory, limit to 10 files
for pImage in glob.glob("assets/**/*.jpg", recursive=True)[:50]:
